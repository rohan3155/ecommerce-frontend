...
{!loading && (
    ...
    <div className="col-span-1  lg:block hidden"  key={key}>
        ...
        <ul className="py-6 border-b space-y-6 px-8">
            <li className="grid grid-cols-6 gap-2 border-b-1">
                ...
                <div className="flex flex-col col-span-3 pt-2">
                    <span className=" text-md font-semi-bold">{item.ProductName}</span>
                    <span className=" text-sm inline-block pt-2">{item.CategoryName.CategoryName}</span>
                </div>
                <div className="col-span-2 pt-3">
                    <div className="flex items-center space-x-2 text-sm justify-between">
                        <span className="text-primary font-semibold inline-block" id='sellingprice' >₹{item.SellingPrice}</span>
        ...
        <div className="px-8 border-b">
            <div className="flex justify-between py-4 ">
                <span>Subtotal</span>
                <span className="font-semibold text-primary">₹{item.SellingPrice}</span>
