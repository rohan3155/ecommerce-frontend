                                    ...
                                    <tr key={key} >
                                        ...
                                        <td className=''>
                                            <div className="join join-horizontal lg:join-horizontal">
                                                <Link to={`/admin/editsubcategory/${item._id}`} onClick={()=>console.log(item._id)}>
                                                    <button className="btn join-item"><i className="fa-sharp fa-solid fa-pen-to-square"></i></button></Link>
                                                    <Link to={`/admin/deletesubcategory/${item._id}`} onClick={()=>console.log(item._id)}><button className="btn join-item"><i className="text-red-500 fa-solid fa-trash"></i></button></Link>
                                            </div>
                                        </td>
                                    </tr>
                                ))}
